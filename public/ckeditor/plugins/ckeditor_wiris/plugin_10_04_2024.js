    ...
    var p = function() {
        ...
        return function(e, t, i) {
            ...
            value: function(t) {
                ...
                // ? 23_MAR_2024_DR [MANTIS 2403247]
                Math_Module.IsEdited = true;
                Math_Module.mathrecord({
                    stage: "Edited"
                }, s);
                return s
            }
            ...
            value: function(t, i) {
                ...
                if (e.cache.get(t)) {
                    // ? 23_MAR_2024_DR [MANTIS 2403247]
                    if (i == undefined) Math_Module.mathrecord({
                        stage: "opencatch",
                        mathtype: "image"
                    });
    ...
    var U = function() {
        ...
        return X(e, [{
            ...
            value: function() {
                ...
                //? 23_MAR_2024_DR [MANTIS 2403247] For Open and close without save by DR.
                if (!Math_Module.IsEdited) {
                    Math_Module.mathrecord({
                        stage: "unEdited"
                    });
                }
            ...
            t && W(e.prototype, t), i && W(e, i)
                            ...
                            if ("latex" === this.editMode && DOC_DTD == JATS.toUpperCase()) {
                                if (o.latex = p.getLatexFromMathML(i), this.integrationModel.fillNonLatexNode && !o.latex) {
                                    ...
                                    if (this.contentManager.isNewElement) {
                                        /* IMPACT_START_YA*/
                                        var latex_code = t.document.createTextNode(Math_Module.latex_open().concat(o.latex, Math_Module.latex_close()));
                                        o.node = Math_Module.getMathElement(latex_code);
                                        /* IMPACT_END_YA*/
                                    } else {
                                        console.log('LATEX')
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        ...
                        try {
                            // ? 23_MAR_2024_DR [MANTIS 2403247] | open wiris Images
                            ...
                            if (Math_Module.selMathTex && t) {
                                var range = GlobalEditor.createRange();
                                var dumele = GlobalEditor.document.getById('dummymath');
                                range.moveToPosition(dumele, CKEDITOR.POSITION_AFTER_START);
                                    ...
                                    if (this.integrationModel.getMathmlFromTextNode) {
                                        ...
                                        if (c) {
                                            ...
                                            this.editMode = "latex",
                                                ...
                                                this.editionProperties.temporalImage.setAttribute(l.get("imageMathmlAttribute"),
                                                    a.safeXmlEncode(u));
                                            var d = t ? e.contentWindow : window;
                                            if ("textarea" !== e.tagName.toLowerCase())
                                                if (document.selection) {
                                                    for (var m = 0, f = c.startNode.previousSibling; f;)
