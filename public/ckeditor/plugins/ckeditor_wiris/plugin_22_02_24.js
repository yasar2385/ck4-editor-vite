...
([function(e) {
    ...
    var a = function() {
        ...
        return function(e, t, i) {
            ...
            value: function(t, i, n) {
                var o = "";
                // Math_Module.getParserMathCode(i, "open");
    ...
    var p = function() {
        ...
        return function(e, t, i) {
            ...
            value: function(t) {
                ...
                s = Math_Module.getParserMathCode(s, "save");
                return s
            }
        }, {
            ...
            value: function(t, i) {
                ...
                t = t.replaceAll("$$", "");
                if(t==''){Math_Module.MathError = true; return}
        ...
        return function(e, t, i) {
            ...
            value: function(t, i, n) {
                ...
                if (o.getSelection) {
                    ...
                    var d = window._IsSafari && DOC_DTD == JATS.toUpperCase() ? c.startContainer.parentElement : c.startContainer;
                    if (3 === d.nodeType) return {
                        node: d,
                        caretPosition: c.startOffset
                    };
                    // Safari edit equation issue - IMPACT_AN - 23/11
                    if (!window._IsSafari && d !== c.endContainer) return null;
                    if (1 === d.nodeType) {
                        var h = c.startOffset;
    ...
    var E = function() {
        ...
        return function(e, t, i) {
            ...
            value: function(t, i, n) {
                for (var r = "", s = "".concat(i.tagOpener, "math"), c = "".concat(i.tagOpener, "/math").concat(i.tagCloser), u = t.indexOf(s), d = 0; - 1 !== u;) {
                    r += t.substring(d, u);
                    ...
                    if (-1 === (d = t.indexOf(c, u)) ? d = t.length - 1 : d += -1 !== h ? t.indexOf("/>", u) : c.length, a.isMathmlInAttribute(t, u) || -1 !== h) r += t.substring(u, d);
                        ...
                        m = i.id === o.safeXmlCharacters.id ? a.safeXmlDecode(m) : a.mathMLEntities(m), r += w.createObjectCode(e.mathmlToImgObject(document, m, null, n))
                    }
                    u = t.indexOf(s, d)
                }
    ...
    var j = function() {
        ...
        return function(e, t, i) {
            ...
            value: function() {
                ...
                else if (Math_Module.CHECK_ONLINE(null, this)) {
                    // this.close();
                } else {
            ...
            value: function() {
                ...
                var e = Math_Module.toolbarconfig.general; //"general";
    ...
    var U = function() {
        ...
        return X(e, [{
            ...
            value: function() {
                ...
                if ((t || i || n) && (this.restoreWebsiteScale(), this.lockWebsiteScroll(), setTimeout(function() {
                        e.hideKeyboard()
            ...
            value: function() {
                ...
                if(Math_Module.Math_Id){
                    let Math_Ele = GlobalEditor.document.getById(Math_Module.Math_Id)
                    var _SaveTEX = Math_Module.getParserMathCode(Math_Ele.$.innerText, "save");
                    Math_Ele.$.innerText = _SaveTEX;
                }
            }
        }, {
            ...
            t && W(e.prototype, t), i && W(e, i)
                    ...
                    value: function(e, t, i, n) {
                        ...
                        if (i) {
                            ...
                            //    if(!Math_Module.MATHJAX){Math_Module.checkandUpdate_svgView(o.node, o);}
                            Math_Module.checkandUpdate_svgView(o.node, o);
                                ['', 'inline'].includes(Math_Module.type) ? this.insertElementOnSelection(o.node, e, t) : Math_Module.insertMath(o.node, this.contentManager);
                            } else {
                                /* IMPACT_06_NOV_2023 */
                                o.latex = p.getLatexFromMathML(i);
                                // if(o.latex == ""){
                                //     AlertNewDialog.fire('MATHEDIT');
                                // }
                                /* IMPACT_06_NOV_2023 */
                                if (this.contentManager && this.contentManager.isNewElement) {
                                    o.node = E.mathmlToImgObject(t.document, i, n, this.language), o.node = Math_Module.getWIRISMathElement(o.node);
                                    ['', 'inline'].includes(Math_Module.type) ? this.insertElementOnSelection(o.node, e, t) : Math_Module.insertMath(o.node, this.contentManager);
                                } else {
                                    o.node = E.mathmlToImgObject(t.document, i, n, this.language), this.insertElementOnSelection(o.node, e, t);
                                    o.Edit_Type = this.editMode;
                                    Math_Module.checkandUpdate_svgView(o.node, o);
                                }
                            }
                    ...
                    value: function(e, t, i) {
                        ...
                        if (this.editionProperties.isNewElement)
                            ...
                            if (DOC_DTD == JATS.toUpperCase()) {
                                //Math_Module.triggerMathJaxView(e, this.editionProperties.isNewElement);
                            ...
                            document.selection && 0 === document.getSelection ? (this.editionProperties.isNewElement = !
                                0, this.editionProperties.latexRange.select(),
                                ...
                                //? Remove inner https://stackoverflow.com/questions/11305797/remove-zero-width-space-characters-from-a-javascript-string by Durai
                                this.editionProperties.latexRange.commonAncestorContainer.normalize()
                                this.editionProperties.latexRange.commonAncestorContainer.innerText = this.editionProperties.latexRange.commonAncestorContainer.innerText.replace(/[\u200B-\u200D\uFEFF]/g, ''); 
                                // if(Math_Module.MATHJAX){
                                //     Math_Module.MATHJAX_TRIGGER_All_STATE(e, {mathsave:true});
                                // }
                            }
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        ...
                        try {
                            /* IMPACT_START_ANAND RIGHT CLICK EDIT EQUATION*/
                            if (Math_Module.rightClick && t) {
                                var range = GlobalEditor.createRange(), aa= GlobalEditor, math;
                                ...
                                math = ascendant.findOne(".TEX");
                                //math.innerHTML = Math_Module.getParserMathCode(math.innerHTML, "open");
                                aa.getSelection().selectElement(math), range = aa.createRange(), range.moveToPosition(math, CKEDITOR.POSITION_AFTER_START), range.select();
                                var o = e.contentWindow.getSelection();
                                this.editionProperties.range = o.getRangeAt(0)
                                Math_Module.rightClick = false;
                                /* IMPACT_END_ANAND RIGHT CLICK EDIT EQUATION*/                                
                            } else if (t) {
                        ...
                        if (void 0 === t && (t = !0),
                            this.editionProperties.latexRange = null, e)
                            if (i = void 0 !== this.integrationModel.getSelectedItem ? this.integrationModel.getSelectedItem(e, t) : w.getSelectedItem(e, t)) {
                                if (!i.caretPosition && w.containsClass(i.node, l.get("imageClassName")))
                                    ...
                                    if (this.integrationModel.getMathmlFromTextNode) {
                                        ...
                                        /* IMPACT */
                                        let [pp,qq,rr,ss] = [i.node.nodeValue,i.node.wholeText,i.node.nextSibling,CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE]
                                        if (i.node.parentElement.classList.contains("TEX") && qq != "") {
                                            if ((pp == "") || (pp == ss) || (rr && qq.slice(qq.indexOf(rr.nodeValue), qq.length) == rr.nodeValue)) {
                                                //i.node.nodeValue = Math_Module.getParserMathCode(i.node.nodeValue, "open");
                                                console.log(i.node.nodeValue);
                                                i.node.nodeValue =i.node.wholeText;
                                            }
                                        }
                                        /* IMPACT */
                                        var range = p.getLatexFromTextNode(i.node, i.caretPosition);
                                        if (range) {
                                            var u = p.getMathMLFromLatex(range.latex);
            ...
            t += l.get("imageMathmlAttribute"), t += ",src,alt](!Wirisformula)",
                ...
                e.on("instanceReady", function() {
                    ...
                    var intervalID = setInterval(function(f) {
                        if (typeof Math_Module != "undefined") {
                            Math_Module.RenderWirisFormula(f);
                            clearInterval(intervalID);
                        } else {
                            debug.warn("---instanceReady-loop---");
                        }
                    }, 100, e);
                    /* IMPACT_06_NOV_2023 */
                })
