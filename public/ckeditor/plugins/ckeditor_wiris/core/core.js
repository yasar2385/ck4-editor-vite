...
function wrs_getContent(url, postVariables) {
    try {
        url = url.replace("http://localhost/", "https://restutils2.newgen.co/");
        url = url.replace("https://xmleditor.newgen.co/", "https://restutils2.newgen.co/xmlhtmleditor/");
        console.log("----------" + url);
...
function wrs_loadConfiguration() {
    ...
    var configUrl = "http://restutils2.newgen.co/pluginwiris_engine/app/configurationjs";
